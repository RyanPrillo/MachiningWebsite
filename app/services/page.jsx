    ...
    return (
        <article className="bg-white h-auto">
            ...
            <section className="border-t-4 border-t-gray-400 h-auto p-10 grid">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-black font-extrabold text-center underline decoration-blue-400 pt-20 pb-20">Our Services</h2>


                <h3 className="text-black text-xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl text-center font-bold border-t-4 border-gray-400 pt-10">Custom Parts</h3>
                <section className="flex pt-16 border-b-4 border-gray-400">
